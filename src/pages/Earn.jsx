    ...
    <Layout style={{ backgroundImage: `url(${bg})` }}>
      <div className="bg-cover bg-center bg-no-repeat">
        <div className="w-full h-screen bg-white flex flex-col justify-center">
          {/* Top Section */}
          <div className="relative bg-gradient-to-r from-blue-200 via-green-100 to-blue-300 flex flex-col sm:flex-row justify-between items-start sm:items-center mb-4 px-4 lg:px-16 pt-25">
            {/* Profile Info */}
            <div className="flex items-center space-x-2 sm:space-x-4">
              ...
              <div className="flex flex-col gap-2 sm:gap-4 pb-4">
                <h2 className="text-xl sm:text-2xl md:text-3xl font-bold text-gray-900">f451028c9538</h2>
                <div className="flex flex-col sm:flex-row gap-1 sm:gap-4">
                  <p className="text-gray-600 text-xs sm:text-sm">
                    0 Points
                  </p>
                  <p className="text-gray-600 text-xs sm:text-sm">Level Information</p>
                </div>
              </div>
            </div>
          </div>
